...
아마 이떄 만낫던 공포를 느끼기 전 쯤 스타벅스 클론 코딩, 부투스트랩을 활용한 다양한 UI를 만들면서 코딩을 재미 있게 했던 시기였던것 같다. 하지만 여기서 자료구조와 알고리즘을 만나면서 다시 한번 벽을 느끼게 된다. 이때는 스택, 큐까지는 이해 하겠는데 그래프, tree, 시간복잡도가 뭔소리며 BST를 BTS로 착각 하는 등 어려움의 연속이였다...그리고 아침마다 하는 토이는 항상 ㅋㅋㅋ 말을 못하겠다... 어쨋든 이떄는 처음에 객체지향과 재귀를 공부했을때 너무 좋았는데 바로 자료구조, 알고리즘 하자마자 자신감이 떨어졌던 시기 였던 것 같다...그 이후에는 프론트 개발자라면 너무 즐겁게 공부 할 수 있는 컴포넌트 디자인, 리엑트 상태끌어올리기, 비동기 등을 배울 수 있어서 좋았고 서버도 맛 볼수 있어서 재밌게 섹션2를 보냈던 것 같다. 섹션2 시험은 어렵지 않았지만 한번 다시 듣고 싶은 생각이 들었다. 저번에도 느꼈지만 한번 듣는거랑 두번듣는건 확실한 차이가 있었기 때문이다. 내가 놓친 부분을 다시 가져갈수 있는 장점이 있었고 여유롭게 자기 공부 할 시간을 만들수 있었기 때문이다.  

<br />

### 7. 2021 6월 (스터디 활동 및 미니프로젝트)
두번째 기수이동을 하면서 이떄는 목표와 계획을 세우고 스터디 활동을 하면서 동료와 의지하면서 공부했던 것 같다. 자료구조와 알고리즘 부분이 부족했기때문에 무조건 하루에 한문제씩 프로그래머스 1단계를 꾸준히 풀었고 리엑트 스터디를 만들면서 리엑트에 대한 지식을 공부하고 공부한 내용을 바탕으로 미니프로젝트를 만들어 보는 시간도 가졌던 것 같다. 이때는 너무 재미있게 한거같다.

<br />

### 8. 2021 7~8월 (백엔드를 맛보다)
섹션3에서 재미있었던건 mvc패턴이다. 각각 분리된 디자인 패턴들이 제 각각 부분적으로 역할들을 하기 떄문에 왜 이런식으로 코드를 짰는지 전체적인 흐름을 볼 수 있어서 좋았다. 그리고 여태 1~2티어 아키텍쳐를 공부를 했다면 본격적으로 3티어 아키텍쳐를 공부하면서 풀스택을 경험 할 수 있게 된점도 좋았다. db는 코드스테이츠 커리큘럼상 관계형 데이터 베이스로 기반한 과제가 나오지만 개인적으로 몽고db 과제도 나왔으면 하는 아쉬움도 있다..! 아 그리고 여기서 제일 어려웠던 것 자료구조 알고리즘은 당연한거고 인증보안파트 부분이 어려웠다...개념을 이해하면 쉽게 코드를 짤수 있겠지만 그 개념들을 알고 넘어가는데 오래 걸렸던 것 같다. 아마 이때도 인증보안 파트를 다시 공부해보고 싶은 욕심에 기수 이동을 했던 것 같다.

<br />

### 9. 2021 9월 (1차 프로젝트 sr의 중요성을 느끼다...)
기존에 스터디 했던 분들과 프로젝트 팀을 만들어서 진행했다. 옛날 부터 마음이 잘 맞았기 떄문에 수월하게 할 수 있을거란 믿음이 있었다. 하지만 문제는 그게 아니였다. 팀원들의 개개인의 능력도 중요하고 프로젝트 시작시 SR계획이 매우 중요하단 사실을 알게 되었다. 물론 처음 하는 협업 프로젝트여서 SR단계에서 애를 많이 먹었고 심지어 팀장 역할을 하면서 이것 저것 하느라 정신이 없었다. 하지만 1주라는 짧은 시간 내에 결과물을 만들어서 다행이면서 뿌듯하였다.

<br />

### 10. 2021 10월 (2차 프로젝트 아쉬운 감정만 남은...)
2차 프로젝트는 출발이 매우 좋았다. 그리고 SR도 나쁘지 않아서 이대로 하면 될 것 같았다. 하지만... 뭔가 하면서 이건 수정해야 할 것 같고 뭔가 이거는 삭제해야 할 것 같고... SR계획대로 흘러가지 않게 되었다... 생각보다 변수가 많았고 그때는 안떠올랐던 아이디어가 하면서 떠오르는 경우도 있었다. 설상 가상으로 백신 2차 접종으로 인해 1주일을 거의 앓아 누웠다... 분명 1차때는 그렇게 오래가지 않았는데 2차때는 전신 통증에 발열 증상까지 일주일 내내 아팠다.. 그래도 팀장으로서 아픈 모습 보이면 팀원들의 사기가 떨어질까봐 최대한 웃으면서 진행했던것 같다.. 결국 내가 하고자하는 목표기능은 완벽하게 하지 못했다. 최소한의 기능 구현만 하였고 결과물을 제출하는데 의의를 두었던 것 같다. 그래도 팀원들이 서로 격려하면서 마무리를 잘해서 다행이다. 나중에 정말 저 프로젝트는 손을 한번 볼 필요가 있다.. ㅠㅠ 너무 아쉽다...

<br />

### 11. 2021 11월 (수료식... 이제 다시 시작)
수료 이후 오랜만에 친구들도 만나고, 술도 먹고, 게임도 하고, 밀린 웹툰도보고, 영화도 보면서 달콤한 나날을 보냈던 것 같다. 하지만 이것도 잠시뿐 결국 현타가 왔서 코딩하고 싶은 생각이 들었다! 시간없어서 못들은 강의도 듣고 코딩관련된 이것저것 보면서 다시 코딩의 즐거움을 느꼈다. 다시 시작한다는 생각으로 주도적으로 공부해보자!


<br />

### 12. 2021 12월 (그리고 지금...)
지난 한달 동안 너무 최선을 다해 쉬었기 때문에 다시 정신 차리면서 꾸준히 공부 중에 있다. 최근에 vue를 공부하면서 공부한 내용을 바탕으로 간단하게 개인프로젝트를 진행하였고 지금은 node.js를 복습하면서 몽고 디비를 활용하여 간단한 채팅기능을 만들어볼 예정이다. 물론 기술면접에 이력서 작성 등 준비 할 것들이 많지만 새로운 스택을 공부하는 것 또 한 재미있따... 동시에 두 마리 토끼는 잡을 순 없지만 적절히 시간 조절하면서 준비해야 겠다! 이렇게 한해가 지나갔고 코드스테이츠를 통해 정말 많은 것을 얻어간 느낌이다. 또 한 앞으로 개발자가 되기 위해 어떻게 공부해야 되는지 알게 되어 좋았고 특히 몰입이라는 것을 배울수 있어서 좋았다. 내년에는 나만의 웹 사이트 만들기! 취업하기! 리덕스 복습! 사이드프로젝트 만들기! 등등 하고싶은게 많다! 내년도 변함없이 꾸준함을 잃지 않고 매일 기록 하는 개발자가 되어야 겠다~@
